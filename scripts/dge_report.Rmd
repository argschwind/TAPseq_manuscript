...
ncells <- snakemake@config$dge_ncells[[snakemake@wildcards$sample]]
filt_cells <- ncells - nrow(dge_stats)
```
Expression data for `r ncells` cells were extracted and after filtering for cell barcodes on
whitelist and chimeric reads filtering, a total of **`r filt_cells` cells** remain in the DGE data.
