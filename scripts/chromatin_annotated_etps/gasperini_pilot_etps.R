## Create chromatin annotated ETPs for the pilot experiments in Gasperini et al, 2019
...
# Tested enhancers from the pilot experiments in Gasperini et al. 2019 are used to create ETPs with
...
scm_files <- scm_files[unique(etps$enh_chr)]
...
krnorm_files <- krnorm_files[unique(etps$enh_chr)]
