...
```{r loadData}
# load inner primers to infer tap-seq target genes
primers <- read.csv(here(snakemake@input$primers), stringsAsFactors = FALSE)
...
known_enh <- c("MYC", "GATA1", "ZFPM2", "HBB", "HBD", "HBE1", "HBG1", "HBG2")
