...
expression of their target genes are filtered out, as they probably do not act through enhancer
activation repression. The number of cis-enhancers per gene are counted and plotted.
...
cis_enh_perts <- results %>%
  ...
  filter(!(significant == "sig" & logFC > 0))
