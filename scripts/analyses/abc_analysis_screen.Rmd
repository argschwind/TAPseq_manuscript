...
[Fulco et al., 2019](https://www.biorxiv.org/content/10.1101/529990v1)
```{r annotateChrom}
...
# Annotate Hi-C
Hi-C contact matrices from [Rao et al., 2014](https://www.cell.com/abstract/S0092-8674(14)01497-4)
are imported and the contact frequency for each enhancer - gene pair is calculated.
...
are used to normalize the observed contacts (read counts). Data from the two chromosonal regions on
chromosome 8 and 11 is extracted for any further analyses.
```{r HiCimportFunction}
