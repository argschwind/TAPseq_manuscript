...
UseCells <- subset(NicheData10x,metadata....experiment.. %in% c("2018_2_HSPC") )
...
UseCells <- subset(NicheData10x, idents = c("Ery/Mk prog.","Neutro prog.","Mono prog.","Gran/Mono prog.","LMPPs","large pre-B.","Mk prog.","Eo/Baso prog.","Ery prog.","pro-B"))
