...
Differential expression testing was performed for the data from the screen and results were annotated with epigenome and HiC information. See XXXX. The results are loaded into R. Gene-wise mean expression levels are also loaded.
