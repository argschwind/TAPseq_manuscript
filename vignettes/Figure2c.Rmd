...
Perturbation data are loaded; to see how pertrubation were generated from raw sequencing data, see XXX
...
prturbations <- readRDS(url("http://steinmetzlab.embl.de/TAPdata/TAP.per.RDS")) #Targeted perturb-seq
...
whole.amp.per <-  readRDS(url("http://steinmetzlab.embl.de/TAPdata/Whole.per.RDS")) #Perturb-seq with gRNA amplification, 
