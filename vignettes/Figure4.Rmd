...
mkdir -p ../data/TAP_CT_totalBM/downsampled
mkdir -p ../data/TAP_CT_kitBM/downsampled
mkdir -p ../data/WTX_CT_kitBM/downsampled
mkdir -p ../data/WTX_CT_totalBM/downsampled

wget -O ../data/TAP_CT_totalBM/dge.txt.gz http://steinmetzlab.embl.de/TAPdata/dge_TAPtotalBM.txt.gz
gunzip ../data/TAP_CT_totalBM/dge.txt.gz
wget -O ../data/TAP_CT_kitBM/dge.txt.gz http://steinmetzlab.embl.de/TAPdata/dge_TAPkitBM.txt.gz
gunzip ../data/TAP_CT_kitBM/dge.txt.gz
```
...
unzip -j -d ../data/TAP_CT_kitBM/downsampled TAPkitBM.zip
unzip -j -d ../data/TAP_CT_totalBM/downsampled TAPtotalBM.zip
unzip -j -d ../data/WTX_CT_kitBM/downsampled WholeKitBM.zip
unzip -j -d ../data/WTX_CT_totalBM/downsampled WholeTotalBM.zip
...
dir <- "../data"
files <- c("TAP_CT_kitBM/dge.txt", "TAP_CT_totalBM/dge.txt")
...
newnames <- gsub("2018_2_HSPC_","WTX_CT_kitBM-",colnames(UseCells))
newnames <- gsub("2017_9_totalBM_","WTX_CT_totalBM-",newnames)
...
folders <- c("WTX_CT_kitBM/downsampled/","WTX_CT_totalBM/downsampled/")
...
include <- gsub("2018_2_HSPC_","TAP_CT_kitBM-",include)
include <- gsub("2017_9_totalBM_","TAP_CT_totalBM-",include)
...
folders <- c("TAP_CT_kitBM/downsampled/", "TAP_CT_totalBM/downsampled/")
folders <- file.path(dir, folders)
