...
##this corresponds to the combination of ../data/TAP_DIFFEX_sample1/dge.txt and ../data/TAP_DIFFEX_sample2/dge.txt if the snakemake pipeline was run.
...
mkdir -p ../data/TAP_DIFFEX_sample1/downsampled
mkdir -p ../data/TAP_DIFFEX_sample2/downsampled
mkdir -p ../data/WTX_DIFFEX/downsampled

#Downsampled targeted seq. data, 3.3 Mb
wget http://steinmetzlab.embl.de/TAPdata/TAP1.downsampled.zip
unzip -j -d ../data/TAP_DIFFEX_sample1/downsampled TAP1.downsampled.zip

wget http://steinmetzlab.embl.de/TAPdata/TAP2.downsampled.zip
unzip -j -d ../data/TAP_DIFFEX_sample2/downsampled TAP2.downsampled.zip

#Downsampled whole transcriptome seq. data, 750 Mb
wget http://steinmetzlab.embl.de/TAPdata/WholeTx.downsampled.zip
unzip -j -d ../data/WTX_DIFFEX/downsampled WholeTx.downsampled.zip
