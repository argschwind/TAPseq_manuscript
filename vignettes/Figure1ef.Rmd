...
mkdir -p data
wget http://steinmetzlab.embl.de/TAPdata/TASC_DEEP_p1.zip
unzip -j -d data/TASC_DEEP_p1 TASC_DEEP_p1.zip

wget http://steinmetzlab.embl.de/TAPdata/WTX_REF_DEEP.zip
unzip -j -d data/WTX_REF_DEEP WTX_REF_DEEP.zip

rm TASC_DEEP_p1.zip WTX_REF_DEEP.zip
```
...
folders <- c(
    "k562.82.10x.low" = "data/TASC_DEEP_p1/"
)
...
total.nods <- read.csv(url("http://steinmetzlab.embl.de/TAPdata/WTX_REF_Deep.counts.csv"), row.names=1)
